...
public class Admin_Selecciona_Motorista extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Admin_Selecciona_Motorista
     */
    public Admin_Selecciona_Motorista() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Selecciona_Motorista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Selecciona_Motorista().setVisible(true);
            }
        });
    }
